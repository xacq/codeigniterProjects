			...
			<div class="col-md-12">
				<div class="box box-success">
		            <div class="box-header with-border">
		              <h3 class="box-title">Editar Auditoria</h3>
		            </div>
		            <div class="box-body">
                ...
                <?php
                $base = base_url();
                echo form_open('AuditoriasController/modificar'); //equivale al <form></form> en html
                echo "<br>";
                ...
                echo "<br>";
                echo form_input(array('name' => 'txtAccion', 'placeholder' => 'Ingrese la Accion', 'class' => 'form-control', 'value' => $AUDACCION));
                echo "<br>";

                echo form_label('Tabla:', 'Tabla'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('name' => 'txtTabla', 'placeholder' => 'Ingrese la Tabla', 'class' => 'form-control', 'value' => $AUDTABLA));
                echo "<br>";

                echo form_label('Fecha:', 'Fecha'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('type' => 'date','name' => 'txtFecha', 'placeholder' => 'Ingrese la Fecha', 'class' => 'form-control', 'value' => $AUDFECHA));
                echo "<br>";

                echo form_label('Hora:', 'Hora'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('type' => 'time','name' => 'txtHora', 'placeholder' => 'Ingrese la Hora', 'class' => 'form-control', 'value'=> $AUDHORA));
                echo "<br>";
                echo form_label('Ip:', 'Ip'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('name' => 'txtIp', 'placeholder' => 'Ingrese la Ip', 'class'=>'form-control', 'value' => $AUDIP));
                echo "<br>";

                echo form_label('Host:', 'Host'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('name' => 'txtHost', 'placeholder' => 'Ingrese el Host', 'class'=>'form-control', 'value' => $AUDHOST));
                echo "<br>";

                echo form_label('Sentencia:', 'Sentencia'); //equivale al <label></label> en html
                echo "<br>";
                echo form_input(array('name' => 'txtSentencia', 'placeholder' => 'Ingrese la Sentencia', 'class'=>'form-control', 'value' => $AUDSENTENCIA));
                echo "<br>";

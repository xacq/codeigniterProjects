            ...
            <div class="card-body">
                <table id="table" class="table nowrap" data-paging="true" data-info="true" data-searching="true">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center">Max Estudiantes</th>
                ...
                <tbody>                   
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"><button type="button" onclick="location.href='<?php echo base_url();?>/AsistenciasController/indexEstudiantes?id=<?php echo $curso['CURID'];?>'" class="btn btn-primary">Cargar Estudiantes</button></td>                        
                    </tr>

...
class Autoload extends \CodeIgniter\Config\AutoloadConfig
{
	...
	public function __construct()
	{
		...
		$psr4 = [
			...
			//'Dompdf\\Cpdf'	=> APPPATH . 'ThirdParty/dompdf/vendor/dompdf/dompdf/lib',
			//'Dompdf'      => APPPATH . 'ThirdParty/dompdf/vendor/dompdf/dompdf/src',
		];
		 ...
		 */
		$classmap = [
			//'Dompdf' => APPPATH . 'ThirdParty/dompdf/vendor/dompdf/dompdf/src/Dompdf.php',
		];
